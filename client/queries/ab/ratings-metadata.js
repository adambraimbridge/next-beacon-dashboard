	...
	steps: [
		{
			...
			filters: [
				...
				{"property_name":"page.capi.hasRating","operator":"eq","property_value":"true"},
				{"property_name":"user.isStaff","operator":"eq","property_value":false},
				{"property_name":"user.ab.ratingsMetadata","operator":"eq","property_value":"on"}
			]
		},
		{
			event_collection: 'dwell',
	...
	steps: [
		{
			...
			filters: [
				...
				{"property_name":"page.capi.hasRating","operator":"eq","property_value":"true"},
				{"property_name":"user.isStaff","operator":"eq","property_value":false},
				{"property_name":"user.ab.ratingsMetadata","operator":"eq","property_value":"off"}
			]
		},
		{
